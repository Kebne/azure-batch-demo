...
namespace azurebatchdemo;

internal class AzureBatch
{
    ...
    private const string PoolVMSize = "STANDARD_A2_v2";
    ...
    public static void Execute()
    {
        ...
        {
            Console.WriteLine();
            Console.WriteLine($"One or more exceptions occurred. {ex}");
            Console.WriteLine();
        }
        catch (Exception ex)
        {
    ...
    private static async Task MainAsync()
    {
        ...
        List<string> inputFilePaths = new List<string>(Directory.GetFileSystemEntries(inputPath, "*.jpg",
    ...
    private static async Task<ResourceFile> UploadResourceFileToContainerAsync(CloudBlobClient blobClient, string containerName, string filePath)
    {
        ...
        SharedAccessBlobPolicy sasConstraints = new SharedAccessBlobPolicy
        {
            ...
            Permissions = SharedAccessBlobPermissions.Write | SharedAccessBlobPermissions.Read | SharedAccessBlobPermissions.Add | SharedAccessBlobPermissions.Delete | SharedAccessBlobPermissions.Create | SharedAccessBlobPermissions.List
        };
    ...
    private static async Task CreateJobAsync(BatchClient batchClient, string jobId, string poolId)
    {
        ...
        //job.NetworkConfiguration = new JobNetworkConfiguration("default");
